...
from db.DTOs.URLHTMLContentInfo import HTMLContentType, URLHTMLContentInfo
from db.DTOs.URLInfo import URLInfo
from db.DTOs.URLWithHTML import URLWithHTML
from db.models import AutomatedUrlAgencySuggestion, UserUrlAgencySuggestion, URLHTMLContent, URL, Agency, \
