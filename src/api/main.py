...
app = FastAPI(
    ...
    description="API for collecting data sources. "
                "\n\nBy accessing our API, you are agreeing to our [Terms of Service](https://docs.pdap.io/meta/operations/legal/terms-of-service). "
                "Please read them before you start.",
    docs_url='/api',
    version="0.1.0",
    lifespan=lifespan
)
