...
from src.core.tasks.operators.url_html.scraper.request_interface.constants import HTML_CONTENT_TYPE
from src.core.tasks.operators.url_html.scraper.request_interface.dtos.request_resources import RequestResources
