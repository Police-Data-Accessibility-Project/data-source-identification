...
"""
from sqlalchemy import Column, Integer, String, TIMESTAMP, Float, JSON, ForeignKey, Text, UniqueConstraint, \
    Boolean, ARRAY
...
from src.db.models.helpers import get_created_at_column, CURRENT_TIME_SERVER_DEFAULT, \
    get_agency_id_foreign_column
from src.db.models.mixins import URLDependentMixin, TaskDependentMixin, BatchDependentMixin, CreatedAtMixin, \
    UpdatedAtMixin
from src.db.models.templates import StandardModel, Base
...
class Duplicate(BatchDependentMixin, StandardModel):
    """
...
class AutomatedUrlAgencySuggestion(URLDependentMixin, StandardModel):
...
class UserUrlAgencySuggestion(URLDependentMixin, StandardModel):
