...
from tests.automated.integration.tasks.url.html.setup.models.record import TestURLHTMLTaskSetupRecord
...
class TestURLHTMLTaskCheckManager:
    ...
    async def _check_marked_as_404(self):
        web_metadata_list: list[URLWebMetadata] = await self.adb_client.get_all(URLWebMetadata)
